...
import fr.marvinlabs.unlocker.core.Authorization.AuthorizationColumns;
...
public abstract class AuthorizationContentProvider extends ContentProvider {
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String order) {
		...
		if (policy == null) {
			Authorization.AuthorizationColumns.addRowToCursor(result, false);
	...
	protected void init(String authority) {
